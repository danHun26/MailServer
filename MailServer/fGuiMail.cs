...
{
    public partial class fGuiMail :  System.Windows.Forms.Form
    {
        ...
        public fGuiMail(string serverMail, int portServerMail, string userMailAcc, string passMailAcc) : this()
        {
        ...
        //Tạo trang mới
        private void trangMớiToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                fGuiMail newMail = new fGuiMail(this.serverMail, this.portServerMail, this.userMailAcc, this.passMailAcc);
                this.Hide();
                newMail.ShowDialog();
                this.Close();
            }
        ...
        //Chữ dậm
        private void chữDậmToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        //Mở thư nháp
        private void mởEmailNhápToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                //<> thunhap = new <>;
